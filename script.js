...
// let arr = ['lorem.', 'ipsum.', 'dollar.', 'amet.', 'Dastan.','Hello.']
// console.log(arr.map(item=>{
//    return  item.includes('.')?item.replace('.','.ru') ||  item.replace('.','.com') :item
// }))
...
//     }
//  }
// console.log(myFunction('Dastan.', '.com'))
// console.log(myFunction('Dastan', '.ru'))
...
//     }
// }
// console.log(myFunction('Dastan'))
// console.log(myFunction('Dastanasdasdasdsad'))
// console.log(myFunction('Das'))
...
//     })
// }
// console.log(myFunction(['d','a','s','t']))
// console.log(myFunction(['d','a','s','t','a','n']))
...
//     }
// }
// console.log(myFunction('Dastan ','Dastan '))
// console.log(myFunction('Dastan','Dstan'))
